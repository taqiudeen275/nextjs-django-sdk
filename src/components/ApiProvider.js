...
function ApiProvider(_a) {
    ...
    return (react_1.default.createElement(ApiContext.Provider, { value: config },
        react_1.default.createElement(swr_1.SWRConfig, { value: {
...
function useApiConfig() {
    var context = (0, react_1.useContext)(ApiContext);
    if (!context) {
